...
public enum Tier {
    ...
    NOVICE(700, 3, 12, Formatting.WHITE, "novice"),
    APPRENTICE(1000, 5, 5, Formatting.AQUA, "apprentice"),
    ADVANCED(1500, 7, 2 , Formatting.DARK_BLUE, "advanced"),
    MASTER(2500, 9, 1, Formatting.DARK_PURPLE, "master");
    ...
    Tier(int maxCharge, int upgradeLimit, int weight, Formatting colour, String name){
    ...
    */
     ...
     */
    public Text getNameForTranslation(){
        return Text.translatable("tier." + unlocalisedName);
    }
     ...
     */
    public Text getNameForTranslationFormatted(){
        return Text.translatable("tier." + unlocalisedName).formatted(this.colour);
    }
